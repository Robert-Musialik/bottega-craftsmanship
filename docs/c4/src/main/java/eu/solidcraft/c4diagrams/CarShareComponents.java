...
import static eu.solidcraft.c4diagrams.Technologies.*;
...
class SampleCarShareModules {
    ...
    SampleCarShareModules(Container carSharing) {
        sampleComponent1 = carSharing.addComponent("Sample component 1", "Sample component 1", SPRING_5_JAVA);
        sampleComponent2 = carSharing.addComponent("Sample component 2", "Sample component 2", SPRING_5_JAVA);
    }
